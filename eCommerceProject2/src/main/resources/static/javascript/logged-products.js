...
window.onload = function () {
    ...
    document.getElementById("cartButton1").addEventListener('click', addToCart)
    document.getElementById("cartButton2").addEventListener('click', addToCart)
    document.getElementById("cartButton3").addEventListener('click', addToCart)
    document.getElementById("cartButton4").addEventListener('click', addToCart)
    document.getElementById("cartButton5").addEventListener('click', addToCart)
    document.getElementById("cartButton6").addEventListener('click', addToCart)
    document.getElementById("cartButton7").addEventListener('click', addToCart)
    document.getElementById("cartButton8").addEventListener('click', addToCart)
}
