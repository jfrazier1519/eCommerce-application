...
INSERT INTO products (product_id, product_name, category_category_id, quantity, price, product_desc, product_review) VALUES (3, 'Grappling Hook', 3, 50, 250.00, 'Adaptable fit for any wrist type', 'Quality is great. Do ya'll offer refunds though? My marriage is in danger if I'm caught playing hero again.');
...
INSERT INTO products (product_id, product_name, category_category_id, quantity, price, product_desc, product_review) VALUES (5, 'Infinity Stones', 2, 6, 2000000.00, 'Thanos sends his regards', 'What a rip-off piece of junk. Waited months for it to show up and it doesn't even...wait. What year is it?');
...
INSERT INTO products (product_id, product_name, category_category_id, quantity, price, product_desc, product_review) VALUES (8, 'Boots of Hermes', 4, 100.00, 100.00, 'adaptable fit to any wrist type', 'Perfect example of high supply, low demand. There's been an increased rate of death by flight lately. You've been warned.');
